...
import SignupScreen from './auth/signup/signup-screen';
import OtpVerificationScreen from './auth/otpVerification/otpVerification-screen';
import SplashScreen from './main/splash/splash-screen';
